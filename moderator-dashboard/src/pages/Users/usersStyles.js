export const USERS_CSS = `
  ...
  .u-topbar { border-bottom: 1px solid var(--color-border); padding: 0 24px; display: flex; align-items: center; background: var(--color-card); flex-shrink: 0; height: 61px; gap: 14px; position: sticky; top: 0; z-index: 20; }
